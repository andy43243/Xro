...
function Assets:Dropdown(Parent,ScreenAsset,Window,Dropdown)
    ...
    local function AddOption(Option,AddToList,Order)
        ...
        -- Add touch support for mobile with visual feedback
        if UserInputService.TouchEnabled then
            ...
            touchFeedback.BackgroundTransparency = 1
            touchFeedback.Size = UDim2.new(1, 0, 1, 0)
            touchFeedback.ZIndex = OptionAsset.ZIndex + 1
            touchFeedback.Parent = OptionAsset
            
            OptionAsset.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.Touch then
                    touchFeedback.BackgroundTransparency = 0.9
                end
            end)
